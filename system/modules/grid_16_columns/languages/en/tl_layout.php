...
$GLOBALS['TL_LANG']['tl_layout']['responsive-1120-16-pixel.css'][1] = 'Adds a responsive 16-column pixel grid with 1120px, that is triggered by the CSS classes "grid1" to "grid16" and "offset1" to "offset15".'; 
